          ...
          <nav className="flex-1 space-y-1.5">
            ...
            >
              ...
              <div className="flex-1 flex items-center justify-between">
                ...
                <span className="bg-[#415144] px-1.5 py-0.5 text-[9px] font-bold text-[#F9F7F2] rounded-md">
          ...
          <div className="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8 space-y-8 select-text">
            ...
            {activeTab === "ocr" && (
              <div className="animate-fadeIn" id="ocr-tab-content">
                <OcrModule isOffline={isOfflineMode} onSetDigitizedLesson={handleSetDigitizedLesson} triggerNotification={triggerNotification} />
              </div>
            )}
            ...
            {activeTab === "curriculum" && (
              <div className="animate-fadeIn" id="curriculum-tab-content">
                <CurriculumBrowser isOffline={isOfflineMode} triggerNotification={triggerNotification} />
              </div>
            )}
            ...
            {activeTab === "archives" && (
              <div className="space-y-6 animate-fadeIn" id="archives-tab-content">
                <div className="bg-white rounded-2xl border border-[#E8E4D9] p-6 shadow-sm">
                  ...
                  <p className="text-xs text-[#8B7E74] mt-1">Manage and view generated lesson outlines, exercises, and evaluation rubrics saved on this device</p>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    <h3 className="font-serif font-bold text-base text-[#4A5D4E] italic flex items-center justify-between border-b border-[#E8E4D9] pb-2">
                      ...
                      <span className="bg-gray-100 text-[#3D352F] px-2.5 py-0.5 rounded-full text-xs font-bold">{savedLessons.length}</span>
                    </h3>
                        ...
                        >
                          <div className="flex items-start justify-between">
                            <div>
                              ...
                              <h4 className="font-serif font-bold text-sm text-[#3D352F] italic">{lesson.topic}</h4>
                              <span className="text-[10px] text-gray-400 mt-1 block">Saved: {lesson.createdAt}</span>
                            </div>
                  ...
                  <div className="space-y-4">
                    <h3 className="font-serif font-bold text-base text-[#4A5D4E] italic flex items-center justify-between border-b border-[#E8E4D9] pb-2">
                      ...
                      <span className="bg-gray-100 text-[#3D352F] px-2.5 py-0.5 rounded-full text-xs font-bold">{savedQuizzes.length}</span>
                    </h3>
                        ...
                        >
                          <div className="flex items-start justify-between">
                            <div>
                              ...
                              <h4 className="font-serif font-bold text-sm text-[#3D352F] italic">{quiz.topic}</h4>
                              <span className="text-[10px] text-gray-400 mt-1 block">Saved: {quiz.createdAt} • {quiz.questionCount} Questions</span>
                            </div>
                          ...
                          <div className="bg-[#F9F7F2] p-3.5 rounded-lg text-[10.5px] border border-[#E8E4D9]/40 space-y-2 select-text">
                            ...
                            <ul className="list-decimal pl-4 space-y-1">
                              {quiz.data.questions.slice(0, 2).map((q, i) => (
